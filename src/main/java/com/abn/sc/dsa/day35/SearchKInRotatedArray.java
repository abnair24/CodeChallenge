...
public class SearchKInRotatedArray {
    ...
    public static void main(String[] args) {
        ...
        SearchKInRotatedArray searchKInRotatedArray = new SearchKInRotatedArray();
        System.out.println(searchKInRotatedArray.search(new int[] {11, 20, 23, 4, 5, 6, 7, 8, 9}, 0, 8, 4));
    }
}
